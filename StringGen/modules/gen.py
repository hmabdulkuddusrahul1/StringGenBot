...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@elitekingofficial"))
        else:
            ...
            await client.join_chat("@elitekingofficial")
    except KeyError:
        pass
    try:
